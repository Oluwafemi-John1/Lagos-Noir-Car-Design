...
const Vault: React.FC = () => {
  ...
  return (
    <div className="bg-background-dark text-white font-tech antialiased min-h-screen flex flex-col overflow-x-hidden selection:bg-primary selection:text-black bg-grid-pattern">
      {/* Nav */}
      <header className="fixed top-0 left-0 right-0 z-50 glass-panel border-b-0 border-b-white/5">
        <div className="max-w-[1440px] mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-12">
            ...
            <button className="text-sm font-medium text-primary uppercase tracking-widest relative after:content-[''] after:absolute after:-bottom-2 after:left-0 after:w-full after:h-[1px] after:bg-primary after:shadow-[0_0_8px_rgba(212,175,55,0.8)]">The Vault</button>
          ...
          <div className="flex items-center gap-6">
            <div className="relative group cursor-pointer">
              ...
              <span className="absolute top-0 right-0 w-2 h-2 bg-primary rounded-full shadow-[0_0_8px_rgba(212,175,55,0.8)]"></span>
            </div>
      ...
      <main className="pt-28 pb-12 flex-grow px-6 max-w-[1440px] mx-auto w-full">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-10 gap-6">
          ...
          <div className="flex items-center gap-3 text-sm text-muted">
            <span className="w-2 h-2 rounded-full bg-secondary animate-pulse shadow-[0_0_8px_rgba(16,185,129,0.8)]"></span>
          ...
          <div className="lg:col-span-8 glass-panel rounded-sm overflow-hidden flex flex-col min-h-[400px]">
            <div className="p-4 border-b border-white/5 flex justify-between items-center bg-background-dark/50">
              ...
              <div className="flex gap-2">
                <span className="px-2 py-1 rounded bg-secondary/10 text-secondary text-[10px] font-bold uppercase tracking-wider border border-secondary/20">Vessel: MSC Orchestra</span>
            ...
            <div className="relative flex-grow bg-[#0f1623] w-full h-full group">
              <div className="absolute inset-0 opacity-40 mix-blend-screen" style={{backgroundImage: "radial-gradient(circle at 70% 60%, #1e293b 0%, #000000 60%)"}}>
                <svg className="w-full h-full absolute inset-0" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path className="opacity-50" d="M 200 100 Q 400 300 600 250 T 800 350" fill="none" stroke="#D4AF37" strokeDasharray="8 4" strokeWidth="2"></path>
                  <path d="M 200 100 Q 400 300 550 262" fill="none" stroke="#D4AF37" strokeWidth="2" style={{filter: "drop-shadow(0 0 4px #D4AF37)"}}></path>
                </svg>
              </div>
              ...
              <div className="absolute top-[45%] left-[60%] transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
                <div className="relative flex items-center justify-center">
                  ...
                  <span className="relative inline-flex rounded-full h-3 w-3 bg-primary shadow-[0_0_10px_#D4AF37]"></span>
                </div>
            ...
            <div className="bg-background-dark/80 backdrop-blur-md border-t border-white/5 p-6">
              <div className="flex items-center justify-between relative">
                ...
                <div className="absolute top-1/2 left-0 w-2/3 h-0.5 bg-gradient-to-r from-primary/20 via-primary to-primary -z-10 shadow-[0_0_10px_rgba(212,175,55,0.3)]"></div>
                <div className="flex flex-col items-center gap-2 group">
                  <div className="w-8 h-8 rounded-full bg-surface border border-primary flex items-center justify-center shadow-[0_0_10px_rgba(212,175,55,0.2)]">
                ...
                <div className="flex flex-col items-center gap-2 group">
                  <div className="relative w-8 h-8 flex items-center justify-center">
                    ...
                    <div className="relative w-8 h-8 rounded-full bg-primary flex items-center justify-center shadow-[0_0_15px_rgba(212,175,55,0.6)]">
            ...
            <div className="glass-panel p-6 rounded-sm h-full flex flex-col">
              ...
              <div className="flex-grow space-y-3 overflow-y-auto no-scrollbar pr-1">
                {[
                    ...
                    {name: "Customs_Duty_Receipt_004.pdf", date: "Cleared Jan 2024 • 0.8 MB", icon: "receipt_long", color: "secondary"},
                    ...
                    <div key={idx} className="group flex items-center gap-4 p-3 rounded hover:bg-white/5 border border-transparent hover:border-white/5 transition-all cursor-pointer">
                        <div className={`w-10 h-10 bg-${doc.color === 'secondary' ? 'emerald' : doc.color}-500/10 rounded flex items-center justify-center text-${doc.color === 'secondary' ? 'emerald' : doc.color}-400 border border-${doc.color === 'secondary' ? 'emerald' : doc.color}-500/20`}>
              ...
              <div key={item.id} className="min-w-[320px] md:min-w-[400px] snap-center glass-panel rounded-sm overflow-hidden group">
                <div className="h-48 overflow-hidden relative">
                  ...
                  <div className="absolute top-4 right-4 z-20">
                    <span className={`text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wider ${item.status === 'Active' ? 'bg-primary text-black' : 'bg-white/10 backdrop-blur-md text-white border border-white/10'}`}>
                        {item.status}
                    </span>
                  </div>
                </div>
